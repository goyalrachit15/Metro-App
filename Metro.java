...
import java.io.*;
	...
	public class Metro 
	{
		...
		static HashMap<String, Vertex> station;
		...
		{
			return station.containsKey(vname);
		}

		public void addVertex(String vname) 
		{
			Vertex vtx = new Vertex();
			station.put(vname, vtx);
		}

		public void removeVertex(String vname) 
		{
			Vertex vtx = station.get(vname);
			ArrayList<String> keys = new ArrayList<>(vtx.nbrs.keySet());

			for (String key : keys) 
			{
				Vertex nbrVtx = station.get(key);
				nbrVtx.nbrs.remove(vname);
			}

			station.remove(vname);
		}

		public int numEdges() 
		{
			ArrayList<String> keys = new ArrayList<>(station.keySet());
			int count = 0;

			for (String key : keys) 
			{
				Vertex vtx = station.get(key);
		...
		{
			Vertex vtx1 = station.get(vname1);
			Vertex vtx2 = station.get(vname2);
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		private class DijkstraPair implements Comparable<DijkstraPair> 
		{
			...
			*/ 
			...
			The type Metro.DijkstraPair must implement the inherited abstract method Comparable<Metro.DijkstraPair>.compareTo(Metro.DijkstraPair)
		...
		public int dijkstra(String src, String des, boolean nan) 
		{
			...
			while (!heap.isEmpty()) 
			{
				...
				Vertex v = station.get(rp.vname);
				for (String nbr : v.nbrs.keySet()) 
				{
					if (map.containsKey(nbr)) 
					{
						int oc = map.get(nbr).cost;
						Vertex k = station.get(rp.vname);
						int nc;
						if(nan)
		...
		public String Get_Minimum_Distance(String src, String dst) 
		{
			...
			while (!stack.isEmpty()) 
			{
				...
				Vertex rpvtx = station.get(rp.vname);
